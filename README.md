...
2. Open `appsettings.json` and replace the placeholders with your Entra ID App Registration details. You can use either `ClientSecret` or `UsernamePassword` for the `AuthType`.
